...
export const metadata: Metadata = {
  title: "Insights & Blog | ImpactSetu",
  description: "Read the ImpactSetu blog. Discover actionable guides on SEO, website optimization, local map marketing, and web technologies.",
};
      ...
      <section className="relative py-20 bg-[#FDFBF7]/50 dark:bg-slate-950 text-[#2C1E15] dark:text-white border-b border-slate-200/50 dark:border-slate-800/50 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 text-center relative z-10 space-y-6">
          ...
          <p className="text-slate-655 dark:text-slate-400 text-base sm:text-lg max-w-2xl mx-auto font-medium">
            Discover tips, resources, and articles to help you optimize and grow your local presence.
          </p>
        </div>
      </section>
