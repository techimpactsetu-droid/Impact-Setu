...
const packages = [
  ...
  },
  {
    ...
    features: [
      "Up to 10 Pages Premium Website",
      "Free Domain (.in or .com)",
      "High-Speed Hosting & SSL Certificate",
      "5 Professional Business Emails",
      "WhatsApp & Multi-Lead Capture Forms",
  ...
  },
  {
    ...
    features: [
      ...
      "Free Domain (.in or .com)",
      "Scalable Cloud Hosting & SSL",
      "Unlimited Business Emails",
      "Advanced API & Checkout Integration",
